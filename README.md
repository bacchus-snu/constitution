...
* 회원이 비회원으로 전환할 경우 경력과 개인정보를 말소한다. 다만 징계에 의해 비회원으로 전환한 경우 징계의 사실을 기록하기 위해, 또한 제적에 한하여 재입회시 경력 유지를 위해 일부 개인정보를 보존한다. 또한, 삭제가 불가능한 경우에 한하여 최소한의 개인정보를 보존할 수 있다. 이 경우 보존할 개인정보는 규칙으로 정한다.
...
임시 합의는 원활한 동아리 운영을 위해 긴급하게 필요한 사안에 대해 의사 결정하는 절차이다.

### 임시 합의의 효력

* 임시 합의에서 결정되는 사안은 일시적인 것이어야 하며, 그렇지 않은 것은 무효이다.
* 임시 합의에서 결정된 사안은 공지와 동시에 효력을 가진다.
* 임시 합의를 통해 회칙 또는 규칙에 반하는 결정을 내릴 수 있으며, 이는 회칙과 규칙보다 우선한다.

### 임시 합의의 절차

* 정회원 1인 이상의 제안을 통해 임시 합의를 제의할 수 있다.
* 정회원의 4/5 이상이 명시적으로 동의 의사를 밝히면 임시 합의가 성사된다.
* 임시 합의가 성사되면, 대표는 결정된 사안을 공지해야 하며 그 방법은 규칙으로 정한다.
