...
* 모집의 세부사항을 결정할 수 있다. 다만 이는 대표가 구성원으로 포함된 회의에서만 가능하다.
* 준회원이 승급을 위한 조건을 지정하고 변경할 수 있다. 다만 이는 대표가 구성원으로 포함된 회의에서만 가능하다.
...
### 제1조 (준회원의 회원 상태의 변환 연기)

2022년 겨울학기 분기가 끝나는 시점에 준회원인 자에 한해서 퇴회, 승급을 포함한 회원 상태의 전환이 일어나지 않는다.

### 제2조 (준회원의 회원 상태의 변환 기준 의결 및 소급 적용)

제1조에 의해 회원 상태의 변환이 연기된 준회원에 한해서, "준회원의 자격을 유지하기 위한 조건"과 "승급하기 위한 조건"은 2023년 봄학기 분기 중 회원 전체를 대상으로 하는 첫 회의에서 의결로 정한다.
이 조건에 따라 회원 상태의 변환이 연기된 준회원에 한해서 회원 변동을 소급 적용하고, 이에 따라 일어난 회원 변동은  2022년 겨울학기 분기가 끝나는 시점에 일어난 것으로 본다.
