...
* 회원이 비회원으로 전환할 경우 경력과 개인정보를 말소한다. 다만 징계에 의해 비회원으로 전환한 경우 징계의 사실을 기록하기 위해, 또한 제적에 한하여 재입회시 경력 유지를 위해 일부 개인정보를 보존한다. 또한, 삭제가 불가능한 경우에 한하여 최소한의 개인정보를 보존할 수 있다.
