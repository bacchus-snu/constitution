...
이 수정 회칙은 2022년 3분기 공개 모집 기간 이후에 입회 의사를 밝힌 비회원이 발생함에 따라 이에 대한 대응을 규정하는 것을 목적으로 한다.

### 제2조(공개 모집 기간 외 입회)

공개 모집 기간이 아닐 때 입회를 희망하는 자가 있을 경우, 정회원의 3/4 이상의 명시적인 동의가 있을 경우 이를 승인할 수 있다.
