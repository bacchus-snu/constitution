...
어느 분기가 종료될 때, 그 분기 동안 아래 조건을 만족한 회원의 "정회원 활동 분기" 수는 1만큼 증가한다.

* 분기 시작 시점에서 끝 시점까지 회원 상태의 변동 없이 정회원으로 활동했다.
* 해당 분기의 정회원 활동 기준을 만족하였다.
...
* 총회에 참석해야 한다.
  * 이때, 활동회원 중 정회원은 총회 참석 의무에 따른 패널티를 받을 수 있다. 만약 정회원이 총회에 참석하지 않은 경우 1회 경고를 부여하며, 이 경고 사항은 동아리 내 공개된 문서를 통해 투명하게 기록한다.
  * 만약 경고를 보유하고 있는 정회원이 다음 총회에 참석한다면, 보유하고 있는 경고는 무효 처리한다.
  * 만약 경고를 보유하고 있는 정회원이 다음 총회에도 참석하지 않는다면, 해당 정회원을 준회원으로 강등 처리한다.
...
* 회원 상태의 변동이 발생한 경우 대표는 가장 가까운 회의나 총회에서 이를 공지하고 그 기록을 보존해야 한다. 방법은 규칙으로 정한다.
* 회원이 비회원으로 전환할 경우 삭제가 불가능한 것을 제외하고 개인정보를 말소한다. 다만 징계로 인한 비회원 전환 시 징계의 사실을 기록하기 위해 일정 기간 개인정보를 보유한다.

### 인사 기준의 정의

매 분기 아래와 같은 인사 기준을 둘 수 있다.

* "준회원 유지 기준"은 준회원이 준회원 자격을 유지하기 위한 조건이며, 무조건 기준을 만족하는 것으로 정할 수도 있다.
* "승급 기준"은 준회원이 정회원으로 승급하기 위한 조건이며, 무조건 기준을 만족하는 것으로 정할 수는 없다. "준회원 유지 기준"보다 엄밀해야 한다.
* "정회원 유지 기준"은 정회원이 정회원 자격을 유지하기 위한 조건이며, 무조건 기준을 만족하는 것으로 정할 수도 있다.
* "정회원 활동 기준"은 정회원 활동 분기 산입을 위한 조건이며, 무조건 기준을 만족하는 것으로 정할 수는 없다. "정회원 유지 기준"보다 엄밀해야 한다.

### 인사 기준을 결정하는 원칙

* 모든 인사 기준은 동아리의 직무활동과 관련된 것이나 동아리 공공 자원의 운영과 관련된 것으로 한정한다.
* 모든 인사 기준은 예측가능성을 보장해야 한다. 기준을 만족하기 위해 무엇이 더 필요한지 명확하고 신뢰성 있는 지표를 제공할 수 있어야 한다.
* 매 총회 때마다 다가오는 분기의 인사 기준을 결정하는 것을 원칙으로 한다.

### 입회

* 제명된 상태가 아닌 비회원은 공개 모집을 통해 입회 의사를 밝힐 수 있다.
* 입회 의사가 승인되는 시점에서 비회원에서 준회원으로의 전환이 이루어진 것으로 간주한다.
* 모집 기간과 입회 의사를 승인할지 결정하는 방법을 회의를 통해 결정하고 대표가 이를 수행한다.
* 공개 모집을 진행하는 시점에서 진행중인 분기의 승급 기준과 준회원 유지 기준이 결정된 상태여야 하며 이를 모집 공고에 명시해야 한다.

### 퇴회

어느 분기가 끝나는 시점에서 준회원이 준회원 유지 기준을 만족하지 못하면 다음 총회에서 비회원으로 전환된다.

### 승급

어느 분기가 끝나는 시점에서 준회원이 승급 조건을 만족하면 다음 총회에서 정회원으로 전환한다.

### 강등

* 분기가 끝나는 시점에서 정회원이 정회원 유지 기준을 만족하지 못한다면 다음 총회에서 강등하여 준회원으로 전환한다.
* 다만 해당 정회원이 이전에 강등 대상이 된 적이 없다면, 1회에 한하여 강등을 면할 수 있다. 그러나 강등을 면제받은 분기는 정회원 활동 분기로 산입되지 못한다.
...
* 동문회원은 본인이 의사를 밝히면 그 다음 총회에서 정회원으로 전환한다.
...
* 어느 분기가 시작하는 시점에 이 전환이 발생한 경우, 해당 분기를 포함하여 향후 6개 분기가 시작하는 총회에서는 이 전환이 불가하다.
...
* 휴회원이 복귀 의사를 밝힌 후 다가오는 총회에서 정회원으로 전환한다.
* 동문회원의 자격이 있는 휴회원이 기한까지 본 회에 연락하여 복귀 의사를 밝히지 않은 경우, 그 이후 총회에서 동문회원으로 전환한다.
* 동문회원의 자격이 없는 휴회원이 기한까지 본 회에 연락하여 복귀 의사를 밝히지 않은 경우, 그 이후 총회에서 제적의 징계를 내린다.
...
* 재입회하는 자가 이전에 재입회를 한 이력이 있으면, 재입회를 통해 정회원이 된 직후의 분기는 정회원 활동 분기에 산입하지 않는다. (이는 제적과 재입회를 거듭하면서 정회원 활동 분기를 쌓는 것을 방지하기 위함이다.)
...
* 퇴회, 승급, 강등, 동문회원으로 전환, 동문회원에서 정회원으로 전환, 복귀, 제적의 대상이 되는 자를 확정해야 한다.
* 지난 분기를 통해 누적 정회원 활동분기가 가산된 자가 있다면 이를 기록해야 한다.
* 지난 분기의 회계내역에 대해 결산해야 한다.
* 의결에는 전체 정회원 과반의 동의가 필요하다.
* 위 항과 관련하여 어떤 자가 정회원인지를 판단할 때, 회원 상태 변동을 반영하지 않는다.

### 회칙 개정

* 총회 전반기와 후반기 사이에, 회칙의 개정안이 발의된 것이 있다면 이를 심의해야 한다.
* 의결에는 전체 정회원 과반의 동의가 필요하다.
* 위 항과 관련하여 어떤 자가 정회원인지를 판단할 때, 재입회를 제외한 모든 상태 변동을 반영한다.
* 회칙 개정이 승인되면 총회 후반기부터 개정된 회칙에 따라 총회를 진행한다.

### 총회 후반기에 다루는 안건

* 대표의 임기가 완료된 경우 새 대표를 선출해야 한다.
* 재입회를 신청한 자가 있을 경우 이를 받아들일지 심사한다.
* 다가오는 분기의 인사 기준을 정해야 한다.
* 다음 분기동안 진행될 모집의 세부사항을 확정할 수 있다.
* 규칙을 제정하고 개정 및 폐기할 수 있다.
* 기타 활동회원이 발의하는 안건을 다룰 수 있다.
* 의결에는 전체 정회원 과반의 동의가 필요하다.
* 위 항 및 선거 절차와 관련하여 어떤 자가 정회원인지를 판단할 때, 재입회를 제외한 모든 상태 변동을 반영한다.
...
* 전체 회의는 본 회의 상설적인 의사결정기구이다.
* 정회원의 절반 이상이 모여야 전체 회의가 성사된다. 또는 정회원의 1/3 이상이 모였고 활동회원의 절반 이상이 모였을 때, 대표의 승인 하에 전체 회의가 성사된다.
* 또는, 규칙을 통해 전체 회의가 성립할 수 있는 조건을 추가할 수 있다.
* 전체 회의의 정확한 시기는 대표가 결정한다.
* 전체 회의가 예정된 날로부터 1주 이전에 시기가 결정되어야 하며 결정된 시기는 지체 없이 공지되어야 한다. 공지의 방법은 규칙으로 정한다.

### 전체 회의에서 다루는 내용

* 동아리의 직무를 수행하기 위한 내용을 토론하고 의결한다.
* 지난 총회에서 결정하지 못한 인사 기준이 있는 경우 이를 제정할 수 있다. 또는, 인사 기준에서 세부 사항이 모호하거나 미정으로 남아있는 경우 이를 구체화할 수 있다.
* 이미 존재하는 인사 기준을 완화할 수 있다.
* 규칙을 제정하고 개정 및 폐기할 수 있다.
* 그 외 회원이 발의하는 안건을 다룰 수 있다.

### 전체 회의의 의결

* 전체 회의에 참석한 활동회원 과반이 동의한 안건은 의결된다.
* 또는, 위 조항보다 높은 우선순위로, 전체 회의에 참석한 정회원 과반이 동의하면서, 여기에 대표가 포함될 경우 안건은 의결된다.
...
* 일반 회의는 특정 목적을 가지고 본 회의 하위에 존재하는 조직의 상설적인 의사결정기구이다.
* 하위 조직의 설립 절차와, 하위 조직의 구성원 명부를 관리하는 방법, 조직의 리더를 정하는 방법은 규칙으로 정한다.
* 조직 구성원의 절반 이상이 모여야 일반 회의가 성사된다. 또는 조직 구성원의 1/3 이상이 모였고 그 중 1명 이상이 정회원일 때, 조직 리더의 승인 하에 일반 회의가 성사된다.
* 일반 회의의 정확한 시기는 조직 리더가 결정한다.
* 일반 회의가 예정된 날로부터 1주 이전에 시기가 결정되어야 하며 결정된 시기는 지체 없이 공지되어야 한다. 공지의 방법은 규칙으로 정한다.

### 일반 회의에서 다루는 내용

* 조직의 직무를 수행하기 위한 내용을 토론하고 의결한다.
* 조직 구성원의 변동을 토론하고 의결한다.
* 그 외 회원이 발의하는 안건을 다룰 수 있다.

### 일반 회의의 의결

* 일반 회의에 참석한 활동회원 과반이 동의한 안건은 의결된다. 조직 구성원이 아닌 활동회원이 회의에 참석했을 때 의결에 포함해야 한다.
* 또는, 위 조항보다 높은 우선순위로, 일반 회의에 참석한 조직 구성원 과반이 동의하면서, 여기에 조직 리더가 포함될 경우 안건은 의결된다.
...
* 정회원 1인 이상의 제안 또는 전체 회의를 통한 의결로 회칙의 개정을 제의할 수 있다.
* 회칙의 개정은 총회에서의 의결을 통해 확정한다.

### 규칙의 제정과 개정, 폐기

* 총회 또는 회의를 통해 규칙의 제정과 개정, 또는 폐기를 제안하고 확정한다.
* 전체 회의를 통해 규칙을 제정, 개정, 또는 폐기할 수 있다.
...
휴회원에게 어떤 의무를 부과하거나 그 자가 정회원으로 전환하기 위한 인사 기준의 충족여부를 심의할 때, 그 자가 마지막으로 휴회원으로 전환할 당시의 회칙과 규칙을 초과하는 의무나 조건을 강제할 수 없다.
