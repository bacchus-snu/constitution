...
이 수정 회칙은 행정착오로 인해 2020년 6월 총회에서 진행되지 못한 대표단 선출 절차를 대체하는 투표에 관한 사항을 규정함으로써 바쿠스 회칙상 명시된 대표단 선출 절차를 정상적으로 이행하고, 대표단의 공백 상태를 해소함을 목적으로 한다.

### 제2조(정의)

이 수정 회칙에서 사용하는 용어의 뜻은 다음과 같다.

1. "전 대표"란 2020년 1분기의 대표를 말한다.
2. "직전의 대표단 선출 절차"란 바쿠스 회칙상 전 대표의 임기 종료에 따라 2020년 6월 총회에서 진행되어야 했던 대표단 선거를 말한다.
3. "대체 투표"란 직전의 대표단 선출 절차와 동일한 효력을 가지는 대표단 선거를 말한다.

### 제3조(대체 투표의 실시)

전 대표는 대표단의 공백 상태를 해소하기 위하여 대체 투표를 실시할 수 있다.

### 제4조(대체 투표의 효력)

대체 투표는 바쿠스 회칙 중 `대표단의 연임`에 따라, 대표 본인이 연임 의사를 밝혀 실시되는 투표로 간주한다. 또한, 대체 투표를 통해 선출된 대표는 직전의 대표단 선출 절차에 따라 선출된 대표로 간주한다.

### 제5조(투표 절차의 준용)

대체 투표의 절차에 관한 사항은, 이 수정 회칙에서 따로 규정한 경우를 제외하고는 바쿠스 회칙 중 `대표단`에서 정하는 바에 따른다.

### 제6조(대체 투표의 시기)

대체 투표는 이 수정 회칙의 효력이 발생한 시점에서 24시간 내에 실시한다.

### 제7조(대체 투표에 의해 선출된 대표의 임기)

대체 투표에 의해 선출된 대표의 임기는 2020년 6월 총회 직후의 분기를 포함하여 1분기이다. 또한, 대체 투표에 의해 선출된 대표의 임기는 2020년 6월 총회 직후부터 소급하여 시작된 것으로 간주한다.
