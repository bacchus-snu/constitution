...
* 활동회원 중 승급의 절차를 밟고 그 상태를 유지하고 있는 자를 '정회원'이라 한다.
...
* 규칙에서 정하는 방법으로 동아리 내에서 상설적으로 이루어지는 토의에, 참여할 수 있다.
...
준회원은 적절한 직무 수행을 위한 제반사항에 대한 교육을 받을 수 있고, 이를 청구할 수 있다.
...
* 모든 전환의 사실은 공지한다. 그 방법은 규칙으로 정한다.
...
회원의 탈회의 의사를 밝히는 시점에서 비회원으로 전환한다.
...
* 총회에서 정회원 2/3 이상의 동의로 회원 또는 제적된 자에게 제명의 징계를 내릴 수 있다.
...
* 어떤 자가 정회원인지를 판단할 때, 총회 직전 분기가 끝나는 시점에서의 회원 상태 전환은 반영하고 총회 직후 분기가 시작하는 시점에서의 회원 상태 전환은 반영하지 않는다.
...
* 총회 또는 회의에 참석한 자 중 1명을 서기로 한다.
* 서기는 총회 또는 회의의 진행과 의결사항을 기록하여 공지한다. 그 방법은 규칙으로 정한다.
...
대표 또는 부대표가 사퇴의 의사를 밝히고 사퇴할 수 있다.
...
* 승격이 총회 중 발생한 경우 임기는 그 총회 직후 분기를 포함하여 2분기이다.
...
* 정회원 1인 또는 회의를 통해 회칙의 개정을 제의할 수 있다.
...
* 다만 보안의 이유로 비회원에게 비공개로 두는 규칙이 있을 수 있다.
* 모든 회원은 모든 규칙에 자유로이 접근할 수 있어야 한다. 이를 만족하지 못한 규칙은 무효이다.
...
* 이 회칙의 개정 이전에 비활동회원으로 전환된 자는, 활동회원으로 전환하기 전까지는 개정된 회칙에서 새로이 다루는 의무조항을 준수할 의무를 지지 않는다.
* 이 회칙 선포와 동시에 회원 및 징계된 비회원의 분류와 상태, 경력사항은 대표가 확정한다.
* 이 회칙 선포 이후 규칙에서 정하도록 되어 있음에도 불구하고 아직 규칙이 확정되지 않아 모호한 사안에 대해서는 대표의 판단을 우선한다.
